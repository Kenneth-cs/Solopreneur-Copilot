    ...
    <div className="space-y-8">
      ...
      <Card className="flex items-center gap-4 p-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="flex items-center gap-2 rounded-lg bg-[#137FEC] px-6 py-3 font-bold text-white shadow-lg shadow-blue-500/20 hover:bg-blue-600 transition-colors">
      ...
      <div className="grid gap-6 lg:grid-cols-[2fr_1fr]">
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-4 md:grid-cols-3">
              ...
              <Card className="relative overflow-hidden p-4">
                ...
                <div className="absolute bottom-0 left-0 h-1 w-full bg-slate-800">
                  <div className="h-full w-[80%] bg-[#137FEC]" />
                </div>
              </Card>
            ...
            <Card className="space-y-6 p-6">
              ...
              <div className="space-y-2">
                ...
                <div className="flex flex-wrap gap-2 rounded-lg border border-slate-700 bg-slate-900/50 p-3">
                  ...
                  <button className="flex items-center gap-1 px-3 py-1 text-xs text-slate-400 hover:text-white">
                    + 添加功能
                  </button>
                </div>
              </div>
        ...
        <Card className="flex flex-col items-center justify-between bg-slate-900 p-6 shadow-xl">
          ...
          <div className="relative w-full rounded-xl bg-slate-800 p-4">
            ...
            <button className="mt-4 flex w-full items-center justify-center gap-2 rounded-lg bg-red-500 py-3 font-bold text-white shadow-lg shadow-red-500/20 hover:bg-red-600 transition-colors">
