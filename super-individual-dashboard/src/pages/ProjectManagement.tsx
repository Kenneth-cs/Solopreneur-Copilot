    ...
    <div className="space-y-8">
      ...
      <div className="text-center">
        ...
        <div className="flex justify-center gap-4">
          {[
            { value: "02", label: "Days", color: "text-white" },
            { value: "14", label: "Hours", color: "text-red-500" },
            { value: "35", label: "Minutes", color: "text-red-500" },
            { value: "20", label: "Seconds", color: "text-red-500" },
          ].map((item, i) => (
      ...
      <div className="flex items-center gap-6">
        <button className="flex flex-1 items-center justify-center gap-3 rounded-xl bg-red-500 py-4 text-xl font-extrabold text-white shadow-[0_0_20px_rgba(239,68,68,0.3)] hover:bg-red-600 transition-all hover:scale-[1.02]">
          <Rocket className="h-6 w-6" />
          PUBLISH / GO LIVE
        </button>
        <button className="flex w-48 items-center justify-center gap-2 rounded-xl border-2 border-slate-700 py-4 text-lg font-bold text-slate-400 hover:border-slate-600 hover:text-slate-300 transition-colors">
